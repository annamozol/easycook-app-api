...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_delete_other_users_recipe_error(self):
        ...
        new_user = create_user(email='new@example.com', password='123')
    ...
    def test_clear_recipe_ingredients(self):
        """Test clearing ingredients of a recipe."""
    ...
    def test_filter_by_ingredients(self):
        ...
        ingred1 = Ingredient.objects.create(user=self.user, name='Feta Cheese')
        ingred2 = Ingredient.objects.create(user=self.user, name='Chicken')
