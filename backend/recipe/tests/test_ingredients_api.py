...
class PrivateIngtedientsAPITests(TestCase):
    ...
    def test_retrieve_ingridients(self):
        ...
        Ingredient.objects.create(user=self.user, name='Kale', quantity=1)
    ...
    def test_ingredients_limited_to_user(self):
        ...
        self.assertEqual(res.data[0]['measurement'], ingredient.measurement)
